(function(){
    ...
    var gulp = require('gulp'),
        ...
        f7 = {
            ...
            modules: require('./slim-modules.json'),
    ...
    gulp.task('custom', function () {
        ...
        gulp.src(f7.modules.core_standalone.js)
            .pipe(concat('dom7.custom.js'))
            ...
            .pipe(header(f7.customBanner, { pkg : f7.pkg, date: f7.date, modulesList: 'core_standalone' } ))
            .pipe(jshint())
            .pipe(jshint.reporter(stylish))
            .pipe(gulp.dest(paths.custom.scripts))
            .pipe(uglify())
